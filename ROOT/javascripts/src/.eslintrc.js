 ...
 *  path: javascripts/scr/.eslintrc.js
 *
...
module.exports = {
  ...
  globals: {
    ...
    Chart: `readonly`,
    moment: `readonly`,
    // chiptune player library
    libopenmpt: `readonly`,
    ChiptuneJsConfig: `readonly`,
    ChiptuneJsPlayer: `readonly`,
    // choices.js
    Choices: `readonly`,
    // hide your header on scroll library
    Headroom: `readonly`,
    ...
    // global functions
    $: `readonly`,
    metaContent: `readonly`,
    queryStringBase: `readonly`,
    queryStringJSON: `readonly`,
    requestJSON: `readonly`,
    requestOperatorMenu: `readonly`,
    storageAvailable: `readonly`,
    validateParam: `readonly`,
    // .eslint.js
    module: `readonly`,
  },
  parserOptions: {
